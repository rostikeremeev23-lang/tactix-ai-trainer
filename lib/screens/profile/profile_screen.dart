...
1. СИЛЬНАЯ СТОРОНА вЂ” одна конкретная сильная сторона.
2. ЗОНА РОСТА вЂ” одна конкретная проблема.
3. СЛЕДУЮЩАЯ ТРЕНИРОВКА вЂ” одна конкретная учебная задача.
4. СЛОЖНОСТЬ вЂ” BEGINNER, INTERMEDIATE, ADVANCED или CHALLENGE.
5. ОЦЕНКА ПРОГРЕССА вЂ” один короткий вывод.
